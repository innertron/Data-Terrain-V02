  ...
  return (
    <div className="w-full h-full relative group">
      ...
      <div className="absolute bottom-1 left-4 right-4 pointer-events-none opacity-40 hover:opacity-90 transition-opacity flex items-center justify-between">
        <div className={`flex gap-2 text-xs font-mono px-3 py-1 rounded-full ${isDark ? 'text-white/70 bg-black/40 border border-white/10' : 'text-white/90 bg-gray-600/80'}`}>
        ...
        <div className={`flex gap-3 text-xs font-mono px-3 py-1 rounded-full ${isDark ? 'text-white/70 bg-black/40 border border-white/10' : 'text-white/90 bg-gray-600/80'}`}>
