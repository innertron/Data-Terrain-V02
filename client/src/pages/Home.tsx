      ...
      <div className="w-full md:w-[350px] lg:w-[400px] h-full bg-card border-l border-border flex flex-col shadow-2xl z-20 order-1 md:order-2">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto p-4 gap-3">
          ...
          {layerMode === 'layers' ? (
            ...
            selectedSegment ? (
              <div className="p-3 rounded-lg border border-border/40 flex-1 flex flex-col min-h-0" style={{ backgroundImage: 'linear-gradient(rgba(255,255,255,0.3),rgba(255,255,255,0.3)), url(/detail-bg.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
